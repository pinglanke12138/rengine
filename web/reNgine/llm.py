...
from dashboard.models import LLMProviderSettings
...
class LLMVulnerabilityReportGenerator:
    ...
    def __init__(self, logger):
        selected_model = LLMProviderSettings.objects.first()
    ...
    def _openai_chat_completion(self, model_name, system_prompt, user_prompt):
    ...
    def _invoke_openai(self, system_prompt, user_prompt):
        ...
        return self._openai_chat_completion(model_name, system_prompt, user_prompt), None
